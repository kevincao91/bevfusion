...
def main() -> None:
    ...
    parser.add_argument("--config", metavar="FILE", default='configs/nuscenes/det/transfusion/secfpn/camera+lidar/swint_v0p075/convfuser.yaml')
    ...
    parser.add_argument("--out-dir", type=str, default="viz4bydpred")
