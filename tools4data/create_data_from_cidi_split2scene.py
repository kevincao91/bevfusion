...
def make_data(file_list, nuscenes_infos, cam_calib_info, cams_channel_list, out_name, test_flag):
    ...
    for file_path in tqdm(file_list):
        ...
        # 时间信息 从文件名获取
        info["timestamp"] = global_timestamp   #xyc 特例
        ...
        for channel in cams_channel_list:
            ...
            # 时间信息 从文件名获取
            cam_info["timestamp"] = global_timestamp   #xyc 特例
        ...
        if not test_flag:
            ...
            # 从nuscenes_info获取信息，防止数据预处理阶段跳过
            info["gt_boxes"] = nuscenes_info["gt_boxes"]
            info["gt_names"] = nuscenes_info["gt_names"]
            info["gt_velocity"] = nuscenes_info["gt_velocity"]
            info["num_lidar_pts"] = nuscenes_info["num_lidar_pts"]
            info["num_radar_pts"] = nuscenes_info["num_radar_pts"]
            info["valid_flag"] = nuscenes_info["valid_flag"]
